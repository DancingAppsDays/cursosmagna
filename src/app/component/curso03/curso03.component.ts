...
@Component({
  selector: 'app-curso03',
  templateUrl: './curso03.component.html',
  styleUrls: ['./curso03.component.scss'],
  animations: [routeTransitionAnimations]    // the fade-in/fade-out animation.

})
export class Curso03Component implements OnInit {
