...
@Component({
  selector: 'app-c03.2end',
  templateUrl: './c03.2end.component.html',
  styleUrls: ['./c03.2end.component.scss']
})
export class C032endComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.toastSerive.show('Progreso', "Continua así para completar el curso",75);
